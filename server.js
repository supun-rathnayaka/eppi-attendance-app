...
// API 4: Leave Submission (Uses Nodemailer)
app.post('/api/leave/submit', async (req, res) => {
    ...
    try {
        ...
        const mailOptions = {
            ...
            to: process.env.ADMIN_EMAIL, // Make sure you have ADMIN_EMAIL in your .env
        ...
        try {
            ...
            // Don't fail the HTTP request just because the email failed.
        }
